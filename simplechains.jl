...
# ╔═╡ 173aee36-1267-11ed-35bb-ff511bc740a1
using SimpleChains

# ╔═╡ 1b9001f9-2b0b-4ab7-b3e0-76d7b399dd02
network = SimpleChain(
	static(400)
)
...
manifest_format = "2.0"
project_hash = "5eb3804ef5d9d2993ed8fc7c8291ca5bb2121014"
...
[[deps.SimpleChains]]
deps = ["ArrayInterface", "CPUSummary", "ChainRulesCore", "CloseOpenIntervals", "ForwardDiff", "HostCPUFeatures", "IfElse", "LayoutPointers", "LoopVectorization", "ManualMemory", "Polyester", "Random", "SIMDTypes", "SLEEFPirates", "Static", "StaticArrays", "StrideArraysCore", "UnPack", "VectorizationBase", "VectorizedRNG"]
git-tree-sha1 = "1f331dd960cd643ce15f9f5179798291c1c17ab6"
